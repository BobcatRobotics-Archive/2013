...
public class RobotDrive6 implements MotorSafety, IUtility {
    ...
    public static class MotorType {
         ...
         */
        public static final RobotDrive6.MotorType kFrontLeft = new RobotDrive6.MotorType(kFrontLeft_val);
        /**
         * motortype: front right
         */
        public static final RobotDrive6.MotorType kFrontRight = new RobotDrive6.MotorType(kFrontRight_val);
        /**
         * motortype: rear left
         */
        public static final RobotDrive6.MotorType kRearLeft = new RobotDrive6.MotorType(kRearLeft_val);
        /**
         * motortype: rear right
         */
        public static final RobotDrive6.MotorType kRearRight = new RobotDrive6.MotorType(kRearRight_val);
        /**
         * motortype: mid left
         */
        public static final RobotDrive6.MotorType kMidLeft = new RobotDrive6.MotorType(kMidLeft_val);
        /**
         * motortype: mid right
         */
        public static final RobotDrive6.MotorType kMidRight = new RobotDrive6.MotorType(kMidRight_val);
     ...
     * @param midLeftMotor The front right SpeedController object used to drive the robot.
     * @param frontLeftMotor The front left SpeedController object used to drive the robot
     * @param rearRightMotor The back right SpeedController object used to drive the robot.
     * @param midRightMotor The back right SpeedController object used to drive the robot.
     * @param frontRightMotor The front right SpeedController object used to drive the robot.     
     */
    public RobotDrive6(SpeedController frontLeftMotor, SpeedController midLeftMotor, SpeedController rearLeftMotor,
        ...
        if (frontLeftMotor == null || midLeftMotor == null || rearLeftMotor == null || frontRightMotor == null || midRightMotor == null || rearRightMotor == null) {
            m_frontLeftMotor = m_rearLeftMotor = m_frontRightMotor = m_rearRightMotor = m_midRightMotor = m_midLeftMotor = null;
    ...
    public void setLeftRightMotorOutputs(double leftOutput, double rightOutput) {
        ...
        m_rearLeftMotor.set(limit(leftOutput) * m_invertedMotors[RobotDrive6.MotorType.kRearLeft_val] * m_maxOutput, syncGroup);
        if (m_midLeftMotor != null) {
            m_midLeftMotor.set(limit(leftOutput) * m_invertedMotors[RobotDrive6.MotorType.kMidLeft_val] * m_maxOutput, syncGroup);
        }
        
        
        if (m_frontRightMotor != null) {
            m_frontRightMotor.set(-limit(rightOutput) * m_invertedMotors[RobotDrive6.MotorType.kFrontRight_val] * m_maxOutput, syncGroup);
        }
        m_rearRightMotor.set(-limit(rightOutput) * m_invertedMotors[RobotDrive6.MotorType.kRearRight_val] * m_maxOutput, syncGroup);

        if (m_midRightMotor != null) {
            m_midRightMotor.set(-limit(rightOutput) * m_invertedMotors[RobotDrive6.MotorType.kMidRight_val] * m_maxOutput, syncGroup);
        }
     ...
     */
    public void setInvertedMotor(RobotDrive6.MotorType motor, boolean isInverted) {
