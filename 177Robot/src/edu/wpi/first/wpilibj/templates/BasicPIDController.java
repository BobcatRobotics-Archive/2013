 ...
 *
 * This implementation is derived from edu.wpi.first.wpilibj.PIDController
 * however it has been simplified to not use a seperate thread. This is desireable
 * for use in autonomous mode.
 * 
 */
